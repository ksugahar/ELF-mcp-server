...
This server exposes 26 MCP tools plus one prompt: curated documentation,
...
relay-solenoid/Hall-sensor/clutch/benchmark/numeric-anchor/FLUM-law sample-deck playbooks,
