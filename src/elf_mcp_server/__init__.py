...
This server exposes 36 MCP tools plus one prompt: curated documentation,
...
local simulation handoff contracts, bundled help/example/wiki/Python API search, and compact planning aids for
